...
@app.on_message(
    filters.command(["مميزات","مميزات لول"], "")
& filters.group
 )
async def mmmezat(client, message):
        await message.reply_text(f"""**مرحبآ بك عزيزي » {message.from_user.mention}**في قسم مميزات سورس لـول ميوزك\n
⩹━★⊷⌯⌞ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐥𝐨𝐥 🧚‍♀ ⌝⌯⊶★━⩺
...
★ميزه ⦂ تلغراف ميديا برد على الصوره
